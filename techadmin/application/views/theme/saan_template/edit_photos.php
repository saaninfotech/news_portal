...
<div id="cols" class="box">
    ...
    <div id="content" class="box">
        <h1>Welcome Administrator...<span style="float:right">Edit Photos Page</span></h1>
        <!-- Headings -->
      ...
      <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="margin-left:60px;">
                ...
                <tr>
					...
					<br>Present Photo: <br><img src="<?=__ADMIN_UPLOAD_URL . "photos/" . $PhotoArray[0]['photo_id']?>.jpg" width="60" height="60">
					</td>
                </tr>
                <tr>
                    <td>Photo Tagline:</td>
                ...
                <tr>
                    <td><textarea name="photo_tagline" id="photo_tagline"><?=$PhotoArray[0]['photo_tagline']?></textarea></td>
                </tr>
