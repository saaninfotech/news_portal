...
<div id="cols" class="box">
    ...
    <div id="content" class="box">
        <h1>Welcome Administrator...<span style="float:right">Add Videos Page</span></h1>
        <!-- Headings -->
      ...
      <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="margin-left:60px;">
                ...
                <tr>
                    <td><textarea name="video_tagline" id="video_tagline"><?=$PostRetain['video_tagline']?></textarea></td>
                </tr>
