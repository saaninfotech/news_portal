...
<div id="cols" class="box">
  ...
  <div id="content" class="box">
    ...
    <form name="form1" method="post" action="<?=__SITE_URL?>adminhome/add_news">
        ...
        <tr>
          <td><select name="news_category" id="news_category">
			  ...
			  if(is_array($CategoryListArray) && count($CategoryListArray) > 0)
			  {
				...
				{
				?>
                	<option value="<?php echo $catValue['news_category_id']; ?>" <?php echo ($PostRetain['news_category'] == $catValue['news_category_id'])?"selected":"" ?>><?php echo $catValue['news_category_name']; ?></option>
                <?php	
				}
			  }
			  ?>
