            ...
            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="margin-left:60px;">
                ...
                <tr>
                    <td><input name="news_category_name" type="text" id="news_category_name" size="50"
                               value="<?=$CategoryArray['news_category_name']?>" readonly></td>
                </tr>
                <tr>
                    <td>News Category Description:</td>
              </tr>
                <tr>
                    <td><textarea name="news_category_description" id="news_category_description"><?=$CategoryArray['news_category_description']?></textarea></td>
                </tr>
                <tr>
                    <td>News Category Status:</td>
                </tr>
                <tr>
                    <td><select name="news_category_status" id="news_category_status">
                        <option value="active" <?=($CategoryArray['news_category_status'] == "active") ? "selected" : ""?>>
                            Active                        </option>
                        <option value="inactive" <?=($CategoryArray['news_category_status'] == "inactive") ? "selected" : ""?>>
                            Inactive                        </option>
                    </select></td>
                </tr>
                <tr>
