 ...
 * @purpose: This is the bootstrap.php file. This filw consists the initial level configuration for the application
 *
...
//This initializes the session for the Application
@session_start();
